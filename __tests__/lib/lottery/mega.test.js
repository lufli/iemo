...
import { getWinningNumbers, checkNumbersForPrize, calculatePrize } from '@/lib/lottery/mega';

describe('get megamillion', () => {
  ...
  const server = setupServer(rest.get('https://www.megamillions.com/cmspages/utilservice.asmx/GetLatestDrawData', (req, res, ctx) => res(ctx.text(mockResponse))));
  ...
  it('should success when return correct data', async () => {
